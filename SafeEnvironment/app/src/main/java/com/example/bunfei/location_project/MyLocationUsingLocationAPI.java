...
import com.example.bunfei.location_project.LocationUtil.PermissionUtils;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent nextIntent = new Intent(MyLocationUsingLocationAPI.this, MapsActivity.class);
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nextIntent = new Intent(MyLocationUsingLocationAPI.this, NextActivity.class);
